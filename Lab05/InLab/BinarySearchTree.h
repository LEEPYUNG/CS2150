...
//helper methods
    void insertHelper(const string& x, BinaryNode* & curNode);
    BinaryNode* findHelper(const string& x, BinaryNode* curNode) const; 
    string pathToHelper(const string& x, BinaryNode* curNode) const;
    int numNodesHelper(BinaryNode* curNode) const;
