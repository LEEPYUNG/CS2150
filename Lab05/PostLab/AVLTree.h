...
//HELPER Function
 void insertHelper(const string& x, AVLNode* & curNode);
    AVLNode* findHelper(const string& x, AVLNode* curNode) const; 
    string pathToHelper(const string& x, AVLNode* curNode) const;
    int numNodesHelper(AVLNode* curNode) const;

    int Lsize(AVLNode* curNode);
    int Rsize(AVLNode* curNode);

    int getBalance(AVLNode* curNode);
